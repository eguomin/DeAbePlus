...
parser.add_argument('-o', '--output_dir', type=str, default=None) # modified: optionally move output_dir to config file
...
schema = {
    ...
    'properties': {
        ...
        'output_dir': {'type': 'string'}    # Modified: set output_dir here
    },
...
config.setdefault('output_dir', None) # modified: output_dir defaulted as None
...
if args.output_dir is not None: # set output path: check argument first
    output_dir = pathlib.Path(args.output_dir)
elif config['output_dir'] is not None:
    output_dir = pathlib.Path(config['output_dir'])
else:
    raise RuntimeError(f'No output path set as argument or in {args.config}')
