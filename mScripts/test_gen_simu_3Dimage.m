% create aberrations and add to synthetic images based on real images
...
flagGPU = 1;
objType = 5; % 1: 0.8NA; 2: 1.1NA; 3: 0.71NA; 4: 1.2NA (confocal) 5: 1.0NA (2P)
lambda = 0.532; % um
...
% SNR = 20;
RI = 1.33;
psfChoice = 2; % 0: wide-field; 1: light-sheet; 2: confocal or 2P(normalized)
...
fileFolderIn = 'Y:\MG\AO_Project\DeepLearning\TwoPhotonChris\Prepro\Tom20_Heart\';
fileFolderOut = 'Y:\MG\AO_Project\DeepLearning\TwoPhotonChris\Training_DeAbe\';
fileNameBase = 'img_';
imgNumStart = 0;
imgNumEnd = 23;
sliceNumStart = 7;
